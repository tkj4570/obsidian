...
## [2026-06-28 10:00:00] ingest | 大模型中转站，凭啥这么便宜？
- 来源：`raw/transcripts/大模型中转站，凭啥这么便宜？.md`
- 创建源摘要页：[[wiki/sources/大模型中转站，凭啥这么便宜？]]
- 更新：[[wiki/index]]
- 注：解析中转站超低价来源（Codex Plus 订阅漏洞、免费试用批量注册、教育优惠滥用）、盈利模式、安全风险（恶意代码注入、密钥窃取）与选择方法论
