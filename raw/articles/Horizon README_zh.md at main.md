---
title: "Horizon/README_zh.md at main"
source: "https://github.com/Thysrael/Horizon/blob/main/README_zh.md"
author:
published:
created: 2026-06-22
description: "📡 Your own AI-powered news radar. Generates daily briefings in English & Chinese. | 用 AI 构建你专属的新闻雷达 - Horizon/README_zh.md at main · Thysrael/Horizon"
tags:
  - "clippings"
---
## 🌅 Horizon
...
[![Thysrael%2FHorizon | Trendshift](https://camo.githubusercontent.com/8b512971f9e9a3c308666e4e84444190c041ae623a053609b9089f52fdff7819/68747470733a2f2f7472656e6473686966742e696f2f6170692f62616467652f7472656e6473686966742f7265706f7369746f726965732f32323836342f6461696c79)](https://trendshift.io/repositories/22864?utm_source=trendshift-badge&utm_medium=badge&utm_campaign=badge-trendshift-22864) [![Featured｜HelloGitHub](https://camo.githubusercontent.)](https://hellogithub.com/repository/Thysrael/Horizon)

📡 构建你专属的 AI 新闻雷达，生成中英双语日报。 | Your own AI-powered news radar.

[📖 在线演示](https://thysrael.github.io/Horizon/) · [📋 配置指南](https://thysrael.github.io/Horizon/configuration) · [English](https://github.com/Thysrael/Horizon/blob/main/README.md) · [日本語](https://github.com/Thysrael/Horizon/blob/main/README_ja.md)

## 截图

| **按优先级排序的日报**  [![日报总览](https://github.com/Thysrael/Horizon/raw/main/docs/assets/overview_zh.png)](https://github.com/Thysrael/Horizon/blob/main/docs/assets/overview_zh.png) | **背景、总结与评论**  [![新闻详情](https://github.com/Thysrael/Horizon/raw/main/docs/assets/one_news_zh.png)](https://github.com/Thysrael/Horizon/blob/main/docs/assets/one_news_zh.png) |
| --- | --- |

**More Screenshots**

| **终端输出**  [![终端输出](https://github.com/Thysrael/Horizon/raw/main/docs/assets/terminal_log.png)](https://github.com/Thysrael/Horizon/blob/main/docs/assets/terminal_log.png) | **飞书通知**  [![飞书通知](https://github.com/Thysrael/Horizon/raw/main/docs/assets/feishu_zh.png)](https://github.com/Thysrael/Horizon/blob/main/docs/assets/feishu_zh.png) | **邮件推送**  [![邮件推送](https://github.com/Thysrael/Horizon/raw/main/docs/assets/email.png)](https://github.com/Thysrael/Horizon/blob/main/docs/assets/email.png) |
| --- | --- | --- |
...
| 支持方 | 说明 |
| --- | --- |
|  | 优云智算目前正在支持 Horizon。优云智算是 UCloud 旗下 AI 云平台，主打包月、按次的高性价比国模 Agent Plan 套餐，低至 49 元/月起，同时提供官转稳定海外模型。支持接入 Claude Code、Codex 及 API 调用，支持企业高并发、7\*24 技术支持和自助开票。      通过其 [链接](https://www.compshare.cn/?ytag=GPU_YY_git_Horizon) 注册，可获得 5 元平台体验金。 |
...
可以限制日报总条数，并避免单一类别占据过多内容。类别来自 `sources.rss[].category` 等信息源配置。
...
分组限额在 AI 分数过滤之后、内容补充之前执行。未配置 `category_groups` 和 `max_items` 时，筛选行为保持不变。

`data/config.json` 里的任意字符串值都可以通过 `${VAR_NAME}` 引用环境变量。这适合用于 `ai.base_url` 、私有 RSS 链接、Webhook 地址或自定义请求头模板等字段。

完整配置参考请查看 [配置指南](https://github.com/Thysrael/Horizon/blob/main/docs/configuration.md) 。
...
Horizon 非常适合作为 **GitHub Actions** 定时任务运行。查看 [`.github/workflows/daily-summary.yml`](https://github.com/Thysrael/Horizon/blob/main/.github/workflows/daily-summary.yml) 获取现成的工作流配置，可自动生成日报并部署到 GitHub Pages。
...
具体配置见 [配置指南](https://github.com/Thysrael/Horizon/blob/main/docs/configuration.md) 。MCP 工具说明和客户端接入见 [`src/mcp/README.md`](https://github.com/Thysrael/Horizon/blob/main/src/mcp/README.md) 与 [`src/mcp/integration.md`](https://github.com/Thysrael/Horizon/blob/main/src/mcp/integration.md) 。

## 文档

| 文档 | 内容 |
| --- | --- |
| [配置指南](https://github.com/Thysrael/Horizon/blob/main/docs/configuration.md) | AI 模型、信息源、过滤、邮件、Webhook、GitHub Pages 和 MCP 配置 |
| [评分机制](https://github.com/Thysrael/Horizon/blob/main/docs/scoring.md) | Horizon 如何评估和排序新闻 |
| [抓取器](https://github.com/Thysrael/Horizon/blob/main/docs/scrapers.md) | 信息源抓取器说明和扩展细节 |
| [MCP 工具](https://github.com/Thysrael/Horizon/blob/main/src/mcp/README.md) | MCP 客户端可调用的工具说明 |
